...
import { CheckCircle, Wrench, Truck, Package, Shield, Clock, Zap } from "lucide-react"
        ...
        <section className="py-20 px-4">
          <div className="container mx-auto max-w-4xl">
                ...
                <CardContent>
                  <form action="https://formspree.io/f/xpwjovwn" method="POST" className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea id="build_configuration" name="build_configuration" required placeholder="Copy and paste your build list from our customizer here..." rows={4} />
                    </div>
                    
                    <div className="space-y-2">
                      <Label htmlFor="comments">Additional Questions or Comments</Label>
                      <Textarea id="comments" name="comments" placeholder="Any specific requirements or questions..." rows={3} />
                    </div>
            ...
            <div className="mb-16">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <Card className="text-center"><CardHeader><Shield className="h-12 w-12 text-accent mx-auto mb-4" /><CardTitle>Warranty & Support</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Full warranty on all components plus our build guarantee.</p></CardContent></Card>
                <Card className="text-center"><CardHeader><Clock className="h-12 w-12 text-accent mx-auto mb-4" /><CardTitle>Fast Turnaround</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Most builds ship within 5-7 business days.</p></CardContent></Card>
                <Card className="text-center"><CardHeader><Wrench className="h-12 w-12 text-accent mx-auto mb-4" /><CardTitle>Expert Assembly</CardTitle></CardHeader><CardContent><p className="text-muted-foreground">Built by certified technicians with years of experience.</p></CardContent></Card>
              </div>
            </div>
          </div>
        </section>
